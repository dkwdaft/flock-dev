export default {
  ...
  color_wheel_aria:
    "Roue chromatique: utilisez les touches fléchées pour sélectionner la teinte et la saturation",
  ...
  glide_to:
    "glisser %1 vers x %2 y %3 z %4 en %5 ms\n%6 retour? %7 boucle? %8 %9",
  glide_to_seconds:
  ...
  set_fog:
    "définir la couleur du brouillard %1 mode %2 densité %3\ndébut %4 fin %5",
  ...
  decal:
    "décalcomanie sur %1 depuis x: %2 y: %3 z: %4\nangle x: %5 y: %6 z: %7\ntaille x: %8 y: %9 z: %10 matériau: %11",
  ...
  BLOCK_CREATE_BOX_MESSAGE:
    "créer boîte %1 couleur %2 taille %3 × %4 × %5 à %6, %7, %8",

  // Add more custom block translations as needed

  // Tooltip translations - Scene blocks
  set_sky_color_tooltip:
    "Définir la couleur du ciel de la scène.\nMot-clé: sky",
  create_ground_tooltip:
    "Ajouter un plan de sol avec collisions activées à la scène.\nMot-clé: ground",
  ...
  load_character_tooltip:
    "Créer un personnage configurable.\nMot-clé: character",
  load_object_tooltip: "Créer un objet.\nMot-clé: object",
  load_multi_object_tooltip:
    "Créer un objet avec des couleurs.\nMot-clé: object",
  ...
  colour_keyframe_tooltip:
    "Définir une couleur et une durée pour une image clé.",
  ...
  animate_keyframes_tooltip:
    "Animer un ensemble d'images clés sur la forme sélectionnée, avec accélération, boucle et inversion optionnelles.",
  animation_tooltip:
    "Créer un groupe d'animation pour la forme et la propriété sélectionnées, avec des images clés, une accélération, et des options pour boucler et inverser. Choisissez créer, démarrer ou attendre pour contrôler le comportement.",
  control_animation_group_tooltip:
    "Contrôler le groupe d'animation en le lançant, en le mettant en pause ou en l'arrêtant.",
  animate_from_tooltip:
    "Commencer à animer le groupe depuis le temps spécifié (en secondes).",
  stop_animations_tooltip:
    "Arrêter toutes les animations d'images clés sur la forme sélectionnée.\nMot-clé: stop",
  switch_animation_tooltip:
    "Changer l'animation de la forme spécifiée vers l'animation donnée.\nMot-clé: switch",
  play_animation_tooltip:
    "Lancer l'animation sélectionnée une fois sur la forme spécifiée.\nMot-clé: play",
  ...
  wait_tooltip:
    "Attendre pendant un temps spécifié en millisecondes.\nMot-clé: milli",
  wait_seconds_tooltip:
    "Attendre pendant un temps spécifié en secondes.\nMot-clé: wait",
  wait_until_tooltip:
    "Attendre jusqu’à ce que la condition soit vraie.\nMot-clé: until",
  local_variable_tooltip:
    "Créer une version locale d'une variable sélectionnée. Cela masque la variable globale et peut avoir une valeur différente.\nMot-clé: local",
  for_loop2_tooltip:
    "Boucle d’un nombre de départ à un nombre de fin avec un pas donné.",
  for_loop_tooltip:
  ...
  main_light_tooltip:
    "Définit l'intensité de la lumière principale.\nMot-clé: light intensity",
  set_fog_tooltip:
    "Configure le brouillard de la scène. Utilisez début et fin pour définir les distances proche et lointaine.\nMot-clé: fog",
  get_light_tooltip:
    "Obtenir la lumière principale de la scène actuelle.\nMot-clé: light",

  // Tooltip translations - Events blocks
  start_tooltip:
    "Exécute les blocs à l'intérieur au démarrage du projet. Vous pouvez avoir plusieurs blocs de démarrage.\nMot-clé: start",
  forever_tooltip:
  ...
  when_action_event_tooltip:
    "Exécute les blocs à l’intérieur lorsque l’action choisie est appuyée ou relâchée (clavier, tactile ou XR).",
  broadcast_event_tooltip:
    "Diffuse un événement qui est reçu par 'on event'.\nMot-clé: broadcast",
  on_event_tooltip:
    "Exécute le code lorsqu’un événement diffusé est reçu.\nMot-clé: on",
  ...
  greyscale_colour_tooltip:
    "Choisir une couleur en niveaux de gris pour l'élévation.\nMot-clé: grey",
  ...
  ui_slider_tooltip:
    "Ajoute un curseur UI 2D et stocke sa référence dans une variable.",
  ...
  create_box_tooltip:
    "Crée une boîte colorée avec des dimensions et une position spécifiées.\nMot-clé: box",
  create_sphere_tooltip:
    "Crée une sphère colorée avec des dimensions et une position spécifiées.\nMot-clé: sphere",
  create_cylinder_tooltip:
    "Crée un cylindre coloré avec des dimensions et une position spécifiées.\nMot-clé: cylinder",
  ...
  speak_tooltip:
    "Convertit du texte en parole avec l’API Web Speech et un positionnement 3D optionnel.\nMot-clé: speak",
  ...
  ui_button_tooltip:
    "Ajoute un bouton 2D à l’interface utilisateur avec une taille prédéfinie, et stocke le contrôle dans une variable pour une utilisation ultérieure.",
  ui_input_tooltip:
  ...
  AUTO_option: "auto",
  ENABLED_option: "activé",
  DISABLED_option: "désactivé",
  ...
  info_panel_link_ui:
    "Visiter le site web de Flock XR (ouvre dans un nouvel onglet)",
  ...
  canvas_focus_navigation:
    "Canvas 3D sélectionné. Utilisez les flèches ou WASD pour naviguer.",
  ...
  file_too_large_alert:
    "Fichier trop volumineux. La taille maximale est de 5 Mo.",
  ...
  drag_drop_hint: "Déposez pour ouvrir le projet ou importer un extrait",
  drop_unsupported_file_alert:
    "Seuls les fichiers .flock, .json, .fsnip ou .png peuvent être déposés.",
