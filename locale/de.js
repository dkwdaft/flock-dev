export default {
  ...
  skin_tone: "Hautton",
  color_wheel_aria:
    "Farbrad: Verwenden Sie die Pfeiltasten, um Farbton und Sättigung auszuwählen",
  ...
  glide_to:
    "%1 gleitet zu x %2 y %3 z %4 in %5 ms\n%6 zurück? %7 Schleife? %8 %9",
  glide_to_seconds:
  ...
  decal:
    "Aufkleber auf %1 von x: %2 y: %3 z: %4 \nWinkel x: %5 y: %6 z: %7\nGröße x: %8 y: %9 z: %10 Material: %11",
  ...
  create_box:
    "Box hinzufügen %1 %2 Breite: %3 Höhe: %4 Tiefe: %5\nbei x: %6 y: %7 z: %8",
  create_sphere:
    "Kugel hinzufügen %1 %2 Ø x: %3 Ø y: %4 Ø z: %5\nbei x: %6 y: %7 z: %8",
  create_cylinder:
    "Zylinder hinzufügen %1 %2 Höhe: %3 oben: %4 unten: %5 Seiten: %6\nbei x: %7 y: %8 z: %9",
  create_capsule:
    "Kapsel hinzufügen %1 %2 Ø: %3 Höhe: %4\nbei x: %5 y: %6 z: %7",
  create_plane:
  ...
  BLOCK_CREATE_BOX_MESSAGE:
    "erstelle Box %1 Farbe %2 Größe %3 × %4 × %5 bei %6, %7, %8",

  // Scene tooltips
  set_sky_color_tooltip:
    "Stelle die Himmel‑Farbe der Szene ein.\nSchlüsselwort: sky",
  create_ground_tooltip:
    "Füge eine Bodenebene mit aktiven Kollisionen zur Szene hinzu.\nSchlüsselwort: ground",
  set_background_color_tooltip:
    "Setze die Hintergrundfarbe der Szene.\nSchlüsselwort: background",
  create_map_tooltip:
    "Erstelle eine Karte mit dem gewählten Namen und Material.\nSchlüsselwort: map",
  show_tooltip: "Zeige das ausgewählte Objekt.\nSchlüsselwort: show",
  hide_tooltip: "Verberge das ausgewählte Objekt.\nSchlüsselwort: hide",
  dispose_tooltip:
    "Entferne das angegebene Objekt aus der Szene.\nSchlüsselwort: dispose",
  clone_mesh_tooltip:
    "Klon ein Objekt und weise es einer Variable zu.\nSchlüsselwort: clone",

  // Models tooltips
  load_character_tooltip:
    "Erstelle einen konfigurierbaren Charakter.\nSchlüsselwort: character",
  load_object_tooltip: "Erstelle ein Objekt.\nSchlüsselwort: object",
  load_multi_object_tooltip:
    "Erstelle ein Objekt mit Farben.\nSchlüsselwort: object",
  load_model_tooltip: "Lade ein Modell.\nSchlüsselwort: model",

  // Animate tooltips
  glide_to_tooltip:
    "Gleite zu einer Position über eine Dauer mit Optionen für Rückwärts, Schleife und Easing.",
  ...
  animate_keyframes_tooltip:
    "Animiert mehrere Schlüsselbilder am Objekt mit Easing, optionalem Loop und Rückwärtsfunktion.",
  animation_tooltip:
    "Erstelle eine Animationsgruppe mit Schlüsselbildern, Easing, optionaler Schleife und Rückwärtsfunktion. Wähle create, start oder await, um das Verhalten zu steuern.",
  control_animation_group_tooltip:
    "Steuere die Animationsgruppe durch Abspielen, Pausieren oder Stoppen.",
  animate_from_tooltip: "Starte Animation der Gruppe ab gegebener Sekunde.",
  stop_animations_tooltip:
    "Stoppt alle Schlüsselbild‑Animationen des gewählten Objekts.\nSchlüsselwort: stop",
  switch_animation_tooltip:
    "Wechsle die Animation des Objekts zur angegebenen.\nSchlüsselwort: switch",
  play_animation_tooltip:
    "Spiele die gewählte Animation einmal ab.\nSchlüsselwort: play",
  ...
  camera_control_tooltip:
    "Verknüpfe eine Taste mit einer Kamerasteuerungsaktion.",
  camera_follow_tooltip:
    "Lässt die Kamera einem Objekt mit einstellbarem Abstand folgen.\nSchlüsselwort: follow",
  ...
  hull_meshes_tooltip:
    "Erstelle eine konvexe Hülle aus einer Liste von Objekten.\nSchlüsselwort: hull",

  // Connect tooltips
  parent_tooltip:
    "Setze eine Eltern‑Kind‑Beziehung, hält Kind in Weltposition.\nSchlüsselwort: parent",
  parent_child_tooltip:
    "Setze Eltern‑Kind‑Beziehung mit Versatz in X, Y, Z.\nSchlüsselwort: child",
  remove_parent_tooltip:
    "Entferne Elternbeziehung eines Objekts.\nSchlüsselwort: unparent",
  stop_follow_tooltip:
    "Stoppt das Folgen eines Objekts durch ein zweites.\nSchlüsselwort: stopfollow",
  hold_tooltip:
    "Befestige ein Objekt an einem Knochen eines anderen mit Versatz.\nSchlüsselwort: hold",
  drop_tooltip: "Löse ein Objekt von seinem Knochen.",
  follow_tooltip:
    "Lass ein Objekt einem anderen folgen (oben, Mitte, unten) mit Versatz.\nSchlüsselwort: follow",
  export_mesh_tooltip:
    "Exportiere ein Objekt als STL, OBJ oder GLB.\nSchlüsselwort: export",

  // Control tooltips
  wait_tooltip:
    "Warte die angegebene Dauer in Millisekunden.\nSchlüsselwort: milli",
  wait_seconds_tooltip:
    "Warte die angegebene Dauer in Sekunden.\nSchlüsselwort: wait",
  wait_until_tooltip: "Warte, bis Bedingung wahr ist.\nSchlüsselwort: until",
  local_variable_tooltip:
    "Erstelle eine lokale Variable (überschreibt globale mit eigenem Wert).\nSchlüsselwort: local",
  for_loop2_tooltip: "Schleife von Start‑ bis Endwert mit Schritt.",
  for_loop_tooltip:
    "Schleife mit Start, Ende und Schritt. Dropdown zur Auswahl der Loop‑Variable.\nSchlüsselwort: for",
  get_lexical_variable_tooltip: "Hole den Wert einer lexikalischen Variablen",

  // Effects tooltips
  main_light_tooltip:
    "Stelle die Intensität der Hauptbeleuchtung ein.\nSchlüsselwort: light intensity",
  set_fog_tooltip:
    "Konfiguriere den Nebel der Szene. Verwende Start und Ende, um die Nah- und Fernwerte festzulegen.\nSchlüsselwort: fog",
  get_light_tooltip:
    "Hole die aktuelle Szene‑Hauptbeleuchtung.\nSchlüsselwort: fog",

  // Events tooltips
  start_tooltip:
    "Führe Blöcke beim Projektstart aus. Mehrere Startblöcke möglich.\nSchlüsselwort: start",
  forever_tooltip:
    "Führe Blöcke in jedem Frame oder nach Iteration aus.\nSchlüsselwort: forever",
  when_clicked_tooltip:
    "Führe Blöcke aus, wenn ein Objekt geklickt wird.\nSchlüsselwort: click",
  on_collision_tooltip:
    "Führe Blöcke aus bei Kollision oder Ende der Kollision.\nSchlüsselwort: collide",
  when_key_event_tooltip:
    "Führe Blöcke aus, wenn die Taste gedrückt oder losgelassen wird.",
  when_action_event_tooltip:
    "Führe Blöcke aus, wenn die gewählte Aktion gedrückt oder losgelassen wird (Tastatur, Touch oder XR).",
  broadcast_event_tooltip:
    "Sende Ereignis, das von on_event empfangen wird.\nSchlüsselwort: broadcast",
  on_event_tooltip:
    "Führe Code aus, wenn Broadcast‑Ereignis empfangen wird.\nSchlüsselwort: on",

  // Materials tooltips
  change_color_tooltip:
    "Farbe des gewählten Objekts ändern.\nSchlüsselwort: color",
  change_material_tooltip:
    "Wende ausgewähltes Material mit Farbtönung auf Objekt an.\nSchlüsselwort: material",
  text_material_tooltip:
    "Erstelle Material mit Text oder Emoji – Breite, Höhe, Hintergrundfarbe und Größenangabe.",
  place_decal_tooltip:
    "Plaziere Aufkleber auf einem Objekt mit dem ausgewählten Material.",
  decal_tooltip:
    "Erstelle einen Decal mit Position, Normalen, Größe und Material.",
  highlight_tooltip:
    "Heb das ausgewählte Objekt hervor.\nSchlüsselwort: highlight",
  glow_tooltip:
    "Füge dem Objekt einen Leuchteffekt hinzu.\nSchlüsselwort: glow",
  tint_tooltip: "Füge eine Farbtönung hinzu.\nSchlüsselwort: tint",
  set_alpha_tooltip:
    "Setze die Transparenz des Materials auf 0–1.\nSchlüsselwort: alpha",
  clear_effects_tooltip:
    "Entferne visuelle Effekte vom Objekt.\nSchlüsselwort: clear",
  colour_tooltip: "Farbe wählen.\nSchlüsselwort: color",
  skin_colour_tooltip: "Hautfarbe wählen.\nSchlüsselwort: skin",
  greyscale_colour_tooltip:
    "Graustufenfarbe für Höhen wählen.\nSchlüsselwort: grey",
  ...
  show_physics_tooltip:
    "Physik-Kollisionskörper zum Debuggen anzeigen oder ausblenden. Aktivieren zum Anzeigen, deaktivieren zum Ausblenden.\nSchlüsselwort: debug physics collider",
  ...
  ui_slider_tooltip:
    "Füge einen 2D-Schieberegler zur UI hinzu und speichere seine Referenz in einer Variable.",

  // Tooltip translations - Shapes blocks
  create_particle_effect_tooltip:
    "Erstelle einen Partikeleffekt an einem Objekt mit konfigurierbarer Form, Schwerkraft, Größe, Farbe, Transparenz, Lebensdauer, Kraft und Rotation.",
  control_particle_system_tooltip:
    "Steuere das Partikelsystem durch Start, Stopp oder Zurücksetzen.",
  create_box_tooltip:
    "Erstelle eine farbige Box mit angegebenen Maßen und Position.\nSchlüsselwort: box",
  create_sphere_tooltip:
    "Erstelle eine farbige Kugel mit angegebenen Maßen und Position.\nSchlüsselwort: sphere",
  ...
  stop_all_sounds_tooltip:
    "Stoppe alle aktuell in der Szene abgespielten Sounds.\nSchlüsselwort: nosound",
  midi_note_tooltip: "Ein MIDI-Notenwert zwischen 0 und 127.",
  rest_tooltip: "Eine Pause (Stille) in einer Musiksequenz.",
  play_notes_tooltip:
    "Spiele eine Sequenz aus MIDI-Noten und Pausen mit entsprechenden Dauern. Nutzt Objekt für Stereo-Panning. Kann sofort oder nach dem Abspielen zurückkehren.",
  ...
  create_instrument_tooltip:
    "Erstellt ein Instrument und weist es der gewählten Variable zu.",
  instrument_tooltip:
    "Wähle ein Instrument, das für das Abspielen von Noten verwendet wird.",
  speak_tooltip:
  ...
  ui_button_tooltip:
    "Füge einen 2D-Button mit vorgegebener Größe zur UI hinzu und speichere die Kontrolle in einer Variable.",
  ui_input_tooltip:
  ...
  scale_tooltip:
    "Skaliert ein Objekt auf die gegebenen X-, Y-, und Z-Werte und kontrolliert den Ursprung der Skalierung.\nSchlüsselwort: scale",
  resize_tooltip:
    "Ändert die Größe eines Objekts auf die gegebenen X-, Y-, Z-Werte mit Skalierungsursprung.\nSchlüsselwort: resize",
  rotate_model_xyz_tooltip:
    "Drehe das Objekt um die gegebenen X-, Y-, Z-Werte.\nSchlüsselwort: rotate\nSchlüsselwort: rotateby",
  rotate_to_tooltip:
    "Drehe das Objekt in Richtung der angegebenen Koordinaten.\nSchlüsselwort: rotateto",
  look_at_tooltip:
  ...
  min_centre_max_tooltip:
    "Wähle min, center oder max als Pivotpunkt.\nSchlüsselwort: minmax",
  ...
  AUTO_option: "auto",
  ENABLED_option: "aktiviert",
  DISABLED_option: "deaktiviert",
  ...
  invalid_filetype_alert:
    "Es sind nur .json- oder .flock-Projektdateien erlaubt.",
  ...
  drag_drop_hint: "Ablegen, um Projekt zu öffnen oder Snippet zu importieren",
